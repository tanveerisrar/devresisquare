                ...
                <div class="pv_wrapper">
                    ...
                    <div class="pv_card_wrapper">
                        ...
                        @foreach ($properties as $property)
                            <x-backend.property-card class="property-card"
                                propertyName="{{ $property['prop_name'] }}{{ $property['line_1'] ? ', ' : '' }}{{ $property['line_1'] }}{{ $property['line_2'] ? ', ' : '' }}{{ $property['line_2'] }}{{ $property['city'] ? ', ' : '' }}{{ $property['city'] }}"
                                bed="{{ $property['bedroom'] }}" bath="{{ $property['bathroom'] }}"
                                floor="{{ $property['floor'] }}" living="{{ $property['reception'] }}"
                                {{-- living="{{$property['living']}}" --}} type="{{ $property['property_type'] }}"
                                available="{{ $property['available_from'] }}" price="{{ $property['price'] }}"
                                cardStyle="" propertyId="{{ $property['id'] }}" />
                        @endforeach
                ...
                <div class="pv_detail_content">
                    <div class="pv_detail_header">
                        ...
                        <div class="pvdh_btns_wrapper d-flex gap-3">
                            ...
                            <a type="button" class="tab-offers-btn btn btn_secondary btn-sm d-none" data-bs-toggle="modal"
                            ...
                            <a data-url="{{ route('admin.owner-groups.create_group') }}"
                                class="popup-tab-owner-group-create btn btn_secondary btn-sm tab-owners-group-btn d-none">
                                <span>Add Owner Group</span>
                                <span class="icon_btn"></span>
                            </a>
                            <a data-url="{{ route('admin.tenancies.create') }}"
                                class="popup-tab-tenancy-create btn btn_secondary btn-sm tab-tenancy-group-btn d-none">
