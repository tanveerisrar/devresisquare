...
@if (!isset($editMode) || !$editMode)
    ...
    <div class="mb-3">
        <button class="btn btn-outline-primary addForm" data-form="bank_detail" data-id="{{ $contact->id }}">Add New Bank Detail</button>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button class="btn btn-sm btn-outline-danger editBank editForm me-1" data-form="bank_detail" data-id="{{ $contact->id }}" data-bank-detail-id="{{ $bank->id }}" title="Edit Bank Detail">
