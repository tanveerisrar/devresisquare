...
<section class="pricing_section">
    ...
    Includes unlimited properties, document storage, tenant maintenance reporting, and full CRM access via app and desktop.</p>
        ...
        <div class="price_table">
            ...
            <div class="price_table_content">
                <p class="desc">Comprehensive solution for estate agencies. Multi-user access, branded communications, lead management tools, advanced dashboards, and priority support.</p>
