...
class SysPurchaseInvoiceFactory extends Factory
{
    protected $model = SysPurchaseInvoice::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'invoice_no' => 'PI-' . fake()->unique()->numerify('######'),
            ...
            'status' => fake()->randomElement(['draft', 'received', 'paid', 'partial', 'cancelled']),
