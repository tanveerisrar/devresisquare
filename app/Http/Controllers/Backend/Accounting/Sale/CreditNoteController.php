...
class CreditNoteController extends BaseCrudController
{
    ...
    protected string $viewPath = 'backend.accounting.sale.credit_notes';
    protected string $routeName = 'backend.accounting.sale.credit_notes';
    protected string $title = 'Credit Notes';
    protected array $scope = ['note_type' => 'credit'];
    protected array $fixedValues = ['note_type' => 'credit'];
    protected array $booleanFields = ['is_refunded'];
    protected array $defaults = ['reference_type' => 'sale_invoice', 'note_date' => null];
